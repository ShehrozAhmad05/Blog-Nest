      ...
      <div className="w-full  p-4">
        <div className="flex flex-col justify-center py-24 max-w-md mx-auto h-full">
          <form onSubmit={formik.handleSubmit}>
            <Link
              to="/register"
              className="inline-block text-gray-500 hover:text-orange-500 transition duration-200 mb-8"
            >
              <span>Don't have an account?</span> {""}
              <span />
              <span className="font-bold font-heading">Register here</span>
            </Link>
            {/* show message */}
            {/* show alert */}
            ...
            <input
              className="w-full rounded-full p-4 outline-none border border-gray-100 focus:border-orange-500 shadow placeholder-gray-500 focus:ring focus:ring-orange-200 transition duration-200 mb-4"
              type="text"
            ...
            <div className="flex items-center gap-1 w-full rounded-full p-4 border  border-gray-100 shadow mb-8 focus-within:border-orange-500">
              <input
                className="outline-none flex-1 placeholder-gray-500 focus:border-orange-500"
                id="textInput2"
                type="password"
